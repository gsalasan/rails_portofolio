class EducationsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to educations_path, status: :see_other, notice: "Education was successfully destroyed." }
  ...
  private
    ...
    def education_params
      params.expect(education: [ :institution, :degree, :field, :start_date, :end_date ])
    end
end
